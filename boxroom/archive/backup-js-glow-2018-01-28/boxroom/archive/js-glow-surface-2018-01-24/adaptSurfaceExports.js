import adaptComponentDecorator from './adaptComponentDecorator';
...
export default function adaptSurfaceExports(
    {
        Surface,
        adapterName,
        adapterAPI
    ...
    const
        ...
        Component = adaptSurfaceComponentClass({ Surface }),

        createElement = adaptCreateElementFunction({
            createElement: Surface.createElement
        }),
        
        component = adaptComponentDecorator({
    ...
    function decorateComponentFunction(config, componentFunction) {
        const
            ...
            surfaceConfig = Object.assign(
                { render: componentFunction }, config);
